...
{
	// chitangUI: commit c1632a0f11209338fc300c66252bcc4686e609e8
	setattr_copy(&nop_mnt_idmap, inode, attr);
}

static u32 sdfat_make_inode_generation(void)
{
	// chitangUI: d247aabd391c3b2fa4f26874ed9136a7a142fcfd
					    ...
					    struct writeback_control *wbc)
{
	...
	// chitangUI: commit c34b7ac65087554627f4840f4ecd6f2107a68fd1
 ...
 *************************************************************************/
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 12, 0)
// chitangUI: b74d24f7a74ffd2d42ca883d84b7422b8d545901
static int sdfat_getattr(struct mnt_idmap *mnt_idmap,
...
// chitangUI: c1632a0f11209338fc300c66252bcc4686e609e8
static int sdfat_rename(struct mnt_idmap *mnt_idmap,
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 12, 0)
// chitangUI: c1632a0f11209338fc300c66252bcc4686e609e8
static int sdfat_mkdir(struct mnt_idmap *mnt_idmap, struct inode *dir,
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 12, 0)
// chitangUI: c1632a0f11209338fc300c66252bcc4686e609e8
static int sdfat_symlink(struct mnt_idmap *mnt_idmap,
...
// chitangUI: c1632a0f11209338fc300c66252bcc4686e609e8
static int sdfat_setattr(struct mnt_idmap *mnt_idmap,
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 12, 0)
// chitangUI: c1632a0f11209338fc300c66252bcc4686e609e8
static int sdfat_create(struct mnt_idmap *mnt_idmap, struct inode *dir,
...
static const struct file_operations sdfat_file_operations = {
	...
	.unlocked_ioctl  = sdfat_generic_ioctl,
	.fsync       = sdfat_file_fsync,
	// chitangUI: 69df79a4511117f377d6a5909b47bd4fb541b978
...
// chitangUI: 704528d895dd3e7b173e672116b4eb2b0a0fceb0
			...
			struct page *page, struct writeback_control *wbc)
{
	 ...
	 */
	// chitangUI: commit 07888c665b405b1cd3577ddebfeb74f4717a84c4
	bio = bio_alloc(bdev, 1, 0, GFP_NOIO);
...
#endif
	// chitangUI: use mpage_writepages, idk why
...
// chitangUI: 9d6b0cd7579844761ed68926eb3073bab1dca87b
...
{
	return __sdfat_write_begin(file, mapping, pos, len,
...
// chitangUI: cdb4f26a63c391317e335e6e683a614358e70aeb
...
out:
	...
	if (opts->discard) {
		// chitangUI: 70200574cc229f6ba038259e8142af2aa09e6976
