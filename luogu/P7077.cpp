...
namespace call {
        ...
        uint n, m;
        val value[MAXN]; Fn *fns[MAXN]; Fn3 *entry;
        ...
        Fn *readFn() {
                ...
                scanf("%u", &T);
                switch (T) {
                        case 1: return readFn1();
                        case 2: return readFn2();
                        case 3: return readFn3();
                }
                throw "?";
        }
        ...
        void Fn2::run() {
                FOR (i, 1, n) value[i] = (value[i] * mul) % MOD;
        }
